...
var update = __webpack_require__(16)("8f2c45c2", content, false, {});
...
// module
exports.push([module.i, "\n.list-reset[data-v-68ff5483] {\n    max-height: 200px;\n    overflow-y: scroll;\n}\n.loading[data-v-68ff5483] {\n    padding: 50px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_sweetalert2__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sweetalert2_dist_sweetalert2_min_css__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sweetalert2_dist_sweetalert2_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_sweetalert2_dist_sweetalert2_min_css__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        usernameSearchAPI: function usernameSearchAPI(username) {
            var _this = this;

            var apiUrl = window.location.origin + ("/nova-vendor/monthly-report/business_usernames?username=" + username);
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(apiUrl).then(function (_ref) {
                var usernames = _ref.data.usernames;

                _this.results = usernames;
            });
        },
        handleSelectedUser: function handleSelectedUser(_ref2) {
            var id = _ref2.id,
        ...
        setInfluencerReport: function setInfluencerReport($event) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt("return", __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(url, data, {
                                    headers: headers
                                }));
        ...
        saveInfluencerReport: function saveInfluencerReport($event) {
            var _this2 = this;
            ...
            fetch("/nova-vendor/campaign-history-report/save-campaign-report", requestOptions).then(function (result) {
                ...
                if (result.status != 200) {
                    ...
                    result.json().then(function (response) {
                        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.swal({
                            ...
                            self.disabled = false;self.resetForm();
                        });
                    });
                }
    ...
    _c(
      ...
      [
        _c("path", {
          attrs: {
            opacity: "0.2",
            fill: _vm.color === "blue" ? "#007ac4" : "#fff",
            d:
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("Influencer Campaigns History Monthly Report")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "card" }, [
        _c(
          ...
          [
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c(
                "div",
                { staticClass: "w-1/2 rounded my-auto relative pin-t pin-l" },
                [
                  _c("input", {
                    directives: [
                      {
                    ...
                    on: {
                      keyup: function($event) {
                        return _vm.usernameSearchAPI(_vm.username)
                      },
                  ...
                  _vm._v(" "),
                  _vm.results.length && _vm.username.length
                    ? _c(
                        "ul",
                        { staticClass: "list-reset shadow-md max-h-screen" },
                            ...
                            "li",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.handleSelectedUser(result)
                                }
                              }
                            },
                            [
                ...
                _c("input", {
                  ...
                  on: {
                    change: function($event) {
                      return _vm.setInfluencerReport($event)
                    }
                  }
                }),
                _vm._v(" "),
            ...
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                _c(
                  "select",
                  {
                    ...
                    staticClass:
                      "w-full form-control form-input form-input-bordered",
                    attrs: { id: "month", dusk: "title", placeholder: "Month" },
                    on: {
                      change: function($event) {
                        var $$selectedVal = Array.prototype.filter
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                _c(
                  ...
                  _vm._l(_vm.current_year, function(y) {
            ...
            _c("div", { staticClass: "flex items-center" }, [
              _c(
                "button",
                {
                  ...
                  attrs: { dusk: "create-button", disabled: _vm.disabled },
                  on: {
                    click: function($event) {
                      return _vm.saveInfluencerReport($event)
                    }
                  }
                },
                [_c("span", {}, [_vm._v(" Save Report")])]
              )
            ])
          ]
        ),
        ...
        _c(
          "div",
          {
            ...
            staticClass: "loading w-full block text-center"
          },
          [_c("Loading")],
          1
        )
  ...
  function() {
    ...
    return _c("div", { staticClass: "w-1/5 py-6 px-8" }, [
      _c(
        ...
        {
          staticClass: "inline-block text-80 pt-2 leading-tight",
          attrs: { for: "Campaigns Monthly Repor" }
        },
        [
          _vm._v(
